...
def make_base_image(machine, mpi, prepend, append, actual):
    ...
    "ENV LD_LIBRARY_PATH=" + home_dir + "/all_yandasoft/install/lib:/usr/local/lib \n"
    "ENV PATH=" + home_dir + "/all_yandasoft/install/bin:$PATH \n"
    ...
    "    echo \"echo ================================================================================\" >> ~/.bashrc \n"
    "WORKDIR " + home_dir + "/all_yandasoft \n"
    )
...
def make_final_image(machine, mpi, prepend, append, base_image, actual):
    ...
    "-DCMAKE_INSTALL_PREFIX=" + home_dir + "/yandasoft"
    )

    common_part = (
    "FROM " + base_image + " as buildenv\n"
    "# Get child repositories of yandasoft\n"
    "WORKDIR " + home_dir + "\n"
    "RUN rmdir all_yandasoft\n"
    ...
    "# Build\n"
    "RUN mkdir build\n"
    "WORKDIR " + home_dir + "/all_yandasoft/build\n"
    "RUN cmake " + cmake_cxx_compiler + " " + cmake_cxx_flags + " " + cmake_build_flags + " .. \\\n"
    "    && make -j" + str(nproc) + " \\\n"
    "    && make install\n"
    "# Set environment variables\n"
    "ENV LD_LIBRARY_PATH=" + home_dir + "/yandasoft/lib:$LD_LIBRARY_PATH \n"
    "ENV PATH=" + home_dir + "/yandasoft/bin:$PATH \n"
    "# Info files\n"
    "RUN cp " + home_dir + "/all_yandasoft/yandasoft/LICENSE.txt " + home_dir + "/yandasoft\n"
    "WORKDIR " + home_dir + "\n"
    # "# Remove dev files\n"
    # "RUN rm -rf all_yandasoft\n"
    "# Set up aliases in .bashrc\n"
    "RUN echo \"alias rm=\'rm -i\'\" > ~/.bashrc &&\\\n"                                                          
    "    echo \"alias cp=\'cp -i\'\" >> ~/.bashrc &&\\\n"
    "    echo \"alias mv=\'mv -i\'\" >> ~/.bashrc \n"
    ...
    "RUN echo \"echo \" >> ~/.bashrc &&\\\n"
    "    echo \"echo ================================================================================\" >> ~/.bashrc &&\\\n"
    "    echo \"echo 'Welcome to Yandasoft!'\" >> ~/.bashrc &&\\\n"
    "    echo \"echo 'Version PRE RELEASE'\" >> ~/.bashrc &&\\\n"
    "    echo \"echo 'CSIRO Open Source Software Licence Agreement (variation of BSD / MIT License)'\" >> ~/.bashrc &&\\\n"
    "    echo \"echo 'License   : /home/yanda-user/yandasoft/LICENSE.txt'\" >> ~/.bashrc &&\\\n"
    "    echo \"echo 'More info : https://github.com/ATNF/yandasoft/wiki'\" >> ~/.bashrc &&\\\n"
    "    echo \"echo 'Bug report: https://github.com/ATNF/yandasoft/issues'\" >> ~/.bashrc &&\\\n"
    "    echo \"echo ================================================================================\" >> ~/.bashrc \n"
    "WORKDIR " + home_dir + "/data\n"
    )
